# 贡献指南（skill-family-contracts）

本仓是 `skill-family-contracts` 的公开发布镜像，只承载版本化发布物。开发在私有工作区进行，不在本仓公开。

## 问题报告

Bug 报告请在本仓 GitHub Issues 提交：https://github.com/ifoohoo/skill-family-contracts/issues
